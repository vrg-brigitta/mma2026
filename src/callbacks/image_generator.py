...
@callback(
    ...
    Output('image-generator-prompt', 'disabled'),
    State('image-generator-prompt', 'value'),
...
@callback(
    Output('image-generator-prompt', 'value'),
...
@callback(
    ...
    Output('image-generator-prompt', 'disabled', allow_duplicate=True),
    Input('generate-image-button', 'n_clicks'),
    prevent_initial_call=True,
)
